...
const TaskCard = ({
  ...
  const getPriorityTagColor = () => {
    switch (priority) {
      case "Low":
        return "text-emerald-500 bg-emerald-50 border border-emeral-500/10";
  ...
  return (
    <div
      className="bg-white rounded-xl py-4 shadow-md shadow-gray-100 border border-gray-200/50 cursor-pointer mt-4"
      onClick={onClick}
    >
      ...
      <div className="px-4">
        <div className="flex items-center justify-between my-1">
          ...
          <div className="flex items-center justify-center mt-3">
            <AvatorGroup avators={assginedTo || []} />
